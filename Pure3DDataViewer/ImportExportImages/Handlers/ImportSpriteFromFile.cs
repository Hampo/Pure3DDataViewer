...
public class ImportSpriteFromFile : IFileHandler
{
    public string Name => "Import Sprite From File";
    ...
    public FileCallbackResult Handle(P3DFile p3dFile)
    {
        ...
        try
        {
            var spriteChunk = Importer.ImportSprite(ofd.FileName);

            p3dFile.Chunks.Insert(0, spriteChunk);
