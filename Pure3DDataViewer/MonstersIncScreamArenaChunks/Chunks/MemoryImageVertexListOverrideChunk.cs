...
[ChunkAttributes(0x10012)]
public class MemoryImageVertexListOverrideChunk : Chunk
{
    ...
    public MemoryImageVertexListOverrideChunk(EndianAwareBinaryReader br, uint headerSize) : this(br.ReadBytes((int)headerSize))
    {
    }

    public MemoryImageVertexListOverrideChunk(IList<byte> unknown) : base(0x10012)
    {
    ...
    protected override Chunk CloneSelf() => new MemoryImageVertexListOverrideChunk(Unknown);
}
