...
[ChunkAttributes(0x121104)]
public class Vector3DOFChannelOverrideChunk : Chunk
{
    ...
    public Vector3DOFChannelOverrideChunk(EndianAwareBinaryReader br, uint headerSize) : this(br.ReadUInt32(), br.ReadBytes((int)headerSize - sizeof(uint)))
    {
    }

    public Vector3DOFChannelOverrideChunk(uint version, IList<byte> unknown) : base(0x121104)
    {
        _version = version;
    ...
    protected override Chunk CloneSelf() => new Vector3DOFChannelOverrideChunk(Version, Unknown);
}
