...
[ChunkAttributes(0x1000D)]
public class MatrixPaletteOverrideChunk : Chunk
{
    ...
    public MatrixPaletteOverrideChunk(EndianAwareBinaryReader br, uint headerSize) : this(br.ReadBytes((int)headerSize))
    {
    }

    public MatrixPaletteOverrideChunk(IList<byte> unknown) : base(0x1000D)
    {
    ...
    protected override Chunk CloneSelf() => new MatrixPaletteOverrideChunk(Unknown);
}
