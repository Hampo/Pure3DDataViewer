...
[ChunkAttributes(0x10013)]
public class MemoryImageIndexListOverrideChunk : Chunk
{
    ...
    public MemoryImageIndexListOverrideChunk(EndianAwareBinaryReader br, uint headerSize) : this(br.ReadBytes((int)headerSize))
    {
    }

    public MemoryImageIndexListOverrideChunk(IList<byte> unknown) : base(0x10013)
    {
    ...
    protected override Chunk CloneSelf() => new MemoryImageIndexListOverrideChunk(Unknown);
}
