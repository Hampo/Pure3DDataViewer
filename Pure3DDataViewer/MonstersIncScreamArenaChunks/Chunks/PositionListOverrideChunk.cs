...
[ChunkAttributes(0x10005)]
public class PositionListOverrideChunk : Chunk
{
    ...
    public PositionListOverrideChunk(EndianAwareBinaryReader br, uint headerSize) : this(br.ReadBytes((int)headerSize))
    {
    }

    public PositionListOverrideChunk(IList<byte> unknown) : base(0x10005)
    {
    ...
    protected override Chunk CloneSelf() => new PositionListOverrideChunk(Unknown);
}
