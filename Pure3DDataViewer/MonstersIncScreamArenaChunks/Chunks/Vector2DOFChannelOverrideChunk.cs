...
[ChunkAttributes(0x121103)]
public class Vector2DOFChannelOverrideChunk : Chunk
{
    ...
    public Vector2DOFChannelOverrideChunk(EndianAwareBinaryReader br, uint headerSize) : this(br.ReadUInt32(), br.ReadBytes((int)headerSize - sizeof(uint)))
    {
    }

    public Vector2DOFChannelOverrideChunk(uint version, IList<byte> unknown) : base(0x121103)
    {
        _version = version;
    ...
    protected override Chunk CloneSelf() => new Vector2DOFChannelOverrideChunk(Version, Unknown);
}
