...
[ChunkAttributes(0x10014)]
public class MemoryImageVertexDescriptionOverrideChunk : Chunk
{
    ...
    public MemoryImageVertexDescriptionOverrideChunk(EndianAwareBinaryReader br, uint headerSize) : this(br.ReadBytes((int)headerSize))
    {
    }

    public MemoryImageVertexDescriptionOverrideChunk(IList<byte> unknown) : base(0x10014)
    {
    ...
    protected override Chunk CloneSelf() => new MemoryImageVertexDescriptionOverrideChunk(Unknown);
}
