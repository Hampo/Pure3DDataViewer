...
[ChunkAttributes(0x1000B)]
public class MatrixListOverrideChunk : Chunk
{
    ...
    public MatrixListOverrideChunk(EndianAwareBinaryReader br, uint headerSize) : this(br.ReadBytes((int)headerSize))
    {
    }

    public MatrixListOverrideChunk(IList<byte> unknown) : base(0x1000B)
    {
    ...
    protected override Chunk CloneSelf() => new MatrixListOverrideChunk(Unknown);
}
