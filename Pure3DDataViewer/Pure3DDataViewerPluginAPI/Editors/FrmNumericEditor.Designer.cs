...
partial class FrmNumericEditor
{
    /// <summary>
    ...
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmNumericEditor));
        LblPropertyName = new Label();
        BtnOK = new Button();
        BtnCancel = new Button();
        TxtValue = new NumericTextBox();
        SuspendLayout();
        // 
        // LblPropertyName
        // 
        ...
        TxtValue.InvalidColor = Color.Pink;
        TxtValue.Location = new Point(12, 27);
        TxtValue.Name = "TxtValue";
        TxtValue.Size = new Size(255, 23);
        TxtValue.TabIndex = 4;
        TxtValue.ValidColor = Color.White;
        TxtValue.Value = null;
        // 
        // FrmNumericEditor
        // 
        ...
        Name = "FrmNumericEditor";
        ShowIcon = false;
        ShowInTaskbar = false;
        StartPosition = FormStartPosition.CenterParent;
        Text = "Edit Value";
        Shown += FrmNumericEditor_Shown;
        ResumeLayout(false);
        PerformLayout();
    }
